...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit_no_description(self): #done
    ...
    def test_withdraw_no_description(self): #done
        self.food.deposit(900, "deposit")
    ...
    def test_get_balance(self): #done
        self.food.deposit(900, "deposit")
        self.food.withdraw(45.67, "milk, cereal, eggs, bacon, bread")
    ...
    def test_check_funds(self): #done
    ...
    def test_withdraw_no_funds(self): #done
    ...
    def test_transfer_no_funds(self): #done
        self.food.deposit(100, "deposit")
